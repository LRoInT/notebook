...
class NoteBookGUI:  # 窗口类
    ...
    def widget_init(self):
        self.widget_dict["page_option"].append([

        ])
        self.widget_dict["other_widget"].append([
    ...
    def windows_init(self):
        ...
        for widget in range(len(self.widget_dict["page_option"])):  # 填充控件
            self.widget_dict["page_option"][widget].place(relx=0.1, rely=0.05+0.75*widget)
